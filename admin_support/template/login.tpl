...
<html>
    <head>
        <title>{$config.host} - Admin Login</title>
    ...
    <body>
            ...
            <div id="content" class="login">
                ...
                <h1><img src="img/icons/locked.png" alt="" />Admin & Support Panel</h1>
...
<label for="login">Vaš Username</label>
                    <input type="text" onblur="showlabel('login');" onfocus="hidelabel('login');" id="login" name="login" />
                </div>
                <div class="input placeholder">
                    <label for="pass">Vaš Password</label>
                    <input type="password" onblur="showlabel('pass');" onfocus="hidelabel('pass');" id="pass" name="pass" value="" />
                </div>

                <div class="submit">
                    <input type="submit" value="Login"/ src="img/icons/login.png">
                </div>
                </form>
<br>

                
            <div id="securityza">Vaša IP adresa je zabeležena ukoliko dođe do zloupotrebe.</div></div>
