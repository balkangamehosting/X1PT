...
$('#lost_pw a').click(function(){
   $('#login_btn').remove();
   $('#login').html('<form onsubmit="skloni();return false;"><div id="email"><p id="password">Email:</p></div> <div id="email_input"><input type="text" class="inputt" id="emaili" name="email_pw" /></div> <div id="login_btn"><input type="submit" name="submit" value="Posalji sifru" class="login" id="loginbtni" /></div> </form>');
